...
public abstract class Enemigo extends Entidad implements Observer {
    // Estados para la IA
    ...
    // <editor-fold defaultstate="collapsed" desc="ACTUALIZACIONES DE
    // FRAME">//GEN-BEGIN:initComponents
    ...
    @Override
    public void update1(Jugador jugador, Enemigo enemigo) {
        if (enemigo == this.enemigo) {
            // Realizar alguna acción cuando el jugador sea golpeado por este enemigo.
        }
    }
    ...
    // <editor-fold defaultstate="collapsed" desc="COMPORTAMIENTOS
    // GENERALES">//GEN-BEGIN:initComponents
    ...
    // desc="ANIMACIONES">//GEN-BEGIN:initComponents

    public void dibujar(Graphics g, int lvlOffset) {
        if (izq)
            g.drawImage(animaciones[estado][aniIndex], (int) getHitbox().x - handicap - lvlOffset,
                    (int) getHitbox().y - (handicap + (Juego.UNIDAD / 2)), Juego.UNIDAD, Juego.UNIDAD, null);
        else
            g.drawImage(animaciones[estado][aniIndex], (int) getHitbox().x - handicap + Juego.UNIDAD - lvlOffset,
                    (int) getHitbox().y - (handicap + (Juego.UNIDAD / 2)), -Juego.UNIDAD, Juego.UNIDAD, null);
    }
    ...
    // <editor-fold defaultstate="collapsed"
    // desc="PISADOBOX">//GEN-BEGIN:initComponents
